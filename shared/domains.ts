...
const KEYWORDS: Record<Domain, readonly string[]> = {
  climate: [
    'emission', 'greenhouse', 'ghg', 'carbon', 'co2', 'methane', 'warming',
    'temperature', 'fossil', 'clean energy', 'renewable', 'solar', 'wind power',
    'grid', 'decarbon', 'net zero', 'net-zero', 'coal', 'oil ', 'natural gas',
    'climate',
  ],
  cryosphere: [
    'ice', 'glacier', 'permafrost', 'arctic', 'antarctic', 'greenland',
    'sea ice', 'ice sheet', 'cryosphere', 'snowpack', 'frozen',
  ],
  ocean: [
    'ocean', 'marine', 'coral', 'reef', 'amoc', 'overturning', 'acidif',
    'fisher', 'fish stock', 'sea level', 'sea-level',
  ],
  forest: [
    'forest', 'amazon', 'rainforest', 'deforest', 'boreal', 'woodland',
    'dieback', 'tree cover', 'tree-cover', 'logging',
  ],
  biosphere: [
    'biodiversity', 'species', 'wildlife', 'extinction', 'ecosystem', 'habitat',
    'pollinator', 'insect', 'mammal', 'population decline', 'rewild',
  ],
  freshwater: [
    'freshwater', 'aquifer', 'groundwater', 'drought', 'watershed',
    'water scarcity', 'water stress', 'water security', 'river basin',
  ],
  food: [
    'crop', 'agricultur', 'harvest', 'famine', 'food security', 'food system',
    'yield', 'soil', 'farmland', 'fertiliz', 'fertilis',
  ],
  society: [
    'democra', 'authoritarian', 'conflict', 'war', 'human right', 'institution',
    'governance', 'migration', 'displacement', 'misinformation', 'disinformation',
    'polaris', 'polariz', 'civil ', 'rule of law',
  ],
  health: [
    'disease', 'pandemic', 'public health', 'mortality', 'antimicrobial',
    'vaccine', 'vaccination', 'outbreak', 'epidemic',
  ],
  economy: [
    'wealth', 'economic', 'financial', 'poverty', 'inequality', 'investment',
    'market', 'gdp', 'debt', 'labour', 'labor', 'unemploy',
  ],
};
